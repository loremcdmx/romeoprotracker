...
export const LANG_DICT = {
  ru: {
    ...
    leaderboards_player: 'Игрок', leaderboards_prize: 'Приз', leaderboards_source: 'официальная страница GGWF',
  ...
  en: {
    ...
    leaderboards_player: 'Player', leaderboards_prize: 'Prize', leaderboards_source: 'official GGWF page',
  ...
  es: {
    ...
    leaderboards_player: 'Jugador', leaderboards_prize: 'Premio', leaderboards_source: 'página oficial GGWF',
