...
export const LANG_DICT = {
  ru: {
    ...
    tip_br: 'БР', tip_mtt_total: '♠ сыграно МТТ', tip_mtt_since: '♠ сыграно МТТ с последнего отчёта', close: 'закрыть',
  ...
  en: {
    ...
    tip_br: 'BR', tip_mtt_total: '♠ MTTs played', tip_mtt_since: '♠ MTTs played since last report', close: 'close',
  ...
  es: {
    ...
    tip_br: 'BR', tip_mtt_total: '♠ MTT jugados', tip_mtt_since: '♠ MTT jugados desde el último reporte', close: 'cerrar',
