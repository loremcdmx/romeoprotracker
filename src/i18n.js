...
export const LANG_DICT = {
  ru: {
    ...
    pace_title: '💵 $/МТТ и финиш',
    pace_sub: 'темп по выбранному периоду',
    pace_rate_now: '$/МТТ сейчас',
    pace_rate_prev: 'прошлый период',
    ...
    pace_chart_title: '$/МТТ по отрезкам',
    pace_chart_label: 'График доллара с турнира по отрезкам в 1000 МТТ',
  ...
  en: {
    ...
    pace_title: '💵 $/MTT and finish pace',
    pace_sub: 'pace from selected period',
    pace_rate_now: '$/MTT now',
    pace_rate_prev: 'previous period',
    pace_delta: 'change',
    pace_finish: 'to $10M',
    ...
    pace_chart_title: '$/MTT by chunks',
    pace_chart_label: 'Dollar per tournament chart by 1000 MTT chunks',
  ...
  es: {
    ...
    pace_title: '💵 $/MTT y ritmo final',
    pace_sub: 'ritmo del periodo elegido',
    pace_rate_now: '$/MTT ahora',
    pace_rate_prev: 'periodo anterior',
    pace_delta: 'cambio',
    pace_finish: 'hasta $10M',
    ...
    pace_chart_title: '$/MTT por tramos',
    pace_chart_label: 'Gráfico de dólar por torneo en tramos de 1000 MTT',
