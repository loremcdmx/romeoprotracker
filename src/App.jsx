...
export default function App() {
  ...
  // URL-based admin: просто добавьте ?admin в адресную строку
  useEffect(() => {
  ...
  const tryLogin   = () => {
    const p = pwd.trim();
    if (p === ADMIN_KEY) { setAdminMode(true); setShowLogin(false); setPwd(''); setLoginErr(''); }
    else setLoginErr('Неверный ключ: ' + p.length + ' символов введено');
  };
