          ...
          <div style={{display:'flex',flexWrap:'wrap',gap:24,alignItems:'flex-start',justifyContent:'space-between'}}>
            ...
            <div>
              <div style={{fontSize:11,color:'var(--dim)',fontFamily:"'Roboto Mono',monospace",marginBottom:4}}>
                ...
                {' '}
                <span style={{color:'#444'}}>v2.0</span>
              </div>
            ...
            <div style={{maxWidth:420}}>
              ...
              {[
                ['08.04', 'v2.0', 'Рефакторинг: вынесены стили, компоненты, хуки. Быстрая загрузка страницы. Плавные кривые без горбов. Количество турниров на графике. Белая тема. Анимированный счётчик БР. Прогресс-бар $10k→$10M. Подтемы. Vercel Analytics'],
                ...
                ['05.04', 'v1.0', 'Первый запуск — лента, цитаты, пагинация, график марафона. Темы форума. Репутация в стиле GT. Избранное и игнор-лист. Фильтры по лайкам и репе'],
              ].map(([date, ver, desc]) => (
